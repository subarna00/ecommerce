                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        <div class="custom-file ">
                            <input type="file" class="custom-file-input " id="customFile" name="image" placeholder="<?php echo "<img src='{{Storage::url($category->image)}}' class='imggg mb-3'>"?>">
                            <label class="custom-file-label @error('description') is-invalid @enderror "
                                for="customFile">Choose file</label>
                            <img src="{{Storage::url($category->image)}}" class="imggg m-auto p-3">
                            @error('image')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
