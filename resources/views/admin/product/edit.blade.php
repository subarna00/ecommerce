    ...
    <div class="col-lg-10">
        <form action="{{route('products.update',[$product->id])}}" method="POST" enctype="multipart/form-data">@csrf
            ...
            <div class="card mb-6">
                ...
                <div class="card-body">
                <center> <img src="{{Storage::url($product->image)}}" width="150"></center>
                <center> <img src="{{Storage::url($product->flip_image)}}" width="150"></center>
                    ...
                    <div class="form-group ">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input @error('flip_image') is-invalid @enderror  "
                                id="customFile" name="flip_image">
                            <label class="custom-file-label  " for="customFile">Choose file</label>
                            <div>
                            </div>
                            @error('flip_image')
                    ...
                    <div class="form-group">
                        ...
                        <select name="category" class="form-control @error('category') is-invalid @enderror"
                            ...
                            <option value="{{$category->id}}"@if($product ->id==$category->id)selected
